...
const nl_NL = {
  ONBOARDING: {
    WELCOME: {
      GREETING: 'Welkom bij',
      WHAT_IS_OBJECTID_1: 'ObjectID verbindt je digitale wereld, veilig en beschermd.',
      WHAT_IS_OBJECTID_2: 'Maak een gloednieuw profiel aan om te beginnen.',
      CREATE_NEW_PROFILE: 'Maak nieuw profiel aan',
      SELECT_LANGUAGE: 'Selecteer taal',
    },
    PLEDGE: {
      NAVBAR_TITLE: 'ObjectID Belofte',
      TITLE_1: 'Geen rare',
      TITLE_2: 'toestanden',
      ...
      T_AND_C: {
        ...
        FULL: {
          ...
          DEFINITIONS: {
            TITLE: 'Definities',
            DESCRIPTION:
              'De term Service verwijst naar de mobiele applicatie ObjectID Identity Wallet en omvat alle functies, inhoud of diensten die daarin worden aangeboden. Gebruikersgegevens betekent alle gegevens, inloggegevens of informatie die je opslaat of deelt met behulp van de Service. De term Apparaat verwijst naar de mobiele telefoon of hardware waarop de ObjectID-app is geïnstalleerd en wordt gebruikt.',
          },
    ...
    PASSWORD: {
      ...
      COMPLETED: {
        ...
        TITLE_1: 'Je ObjectID profiel is nu',
        TITLE_2: 'beschermd',
  ...
  ADD_CREDENTIALS: {
    ...
    PROFILE: {
      ...
      INFO: {
        ...
        TITLE: 'ObjectID Profiel',
        DESCRIPTION: 'Voordat je begint',
        ITEM_0: {
          TITLE: 'Sla saaie formulieren over',
          DESCRIPTION:
            'Je ObjectID-profiel werkt als een digitale ID. Gebruik het om gegevens direct automatisch in te vullen op ondersteunde sites en houd je online leven overzichtelijk.',
        },
        ITEM_1: {
          TITLE: 'Direct delen',
          DESCRIPTION:
  ...
  DOMAIN_LINKAGE: {
    ...
    SUCCESS: 'ObjectID heeft de identiteit met succes geverifieerd om u een veilige login te geven.',
    FAILURE: 'ObjectID kon de koppeling van de identiteit aan het domein niet verifiëren.',
    UNKNOWN: 'ObjectID kon geen bewijs vinden van de bijbehorende identiteit van het domein.',
