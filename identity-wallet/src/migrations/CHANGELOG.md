...
Since ObjectID is not semantically versioned, the following overview of migrations can be helpful for debugging and testing backwards compatibility.

| ObjectID Version | `AppState` Version | Git commit | Description                                |
| ------------- | -----------------: | ---------- | ------------------------------------------ |
