...
When running OIDwallet via `pnpm tauri dev`, the current state of the app will be written to `debug/state.json`. It can be manually inspected or copied to be diffed later against a new state.
