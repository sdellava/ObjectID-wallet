...
export type TranslationFunctions = {
	ONBOARDING: {
		WELCOME: {
			...
			/**
			 * ObjectID connects your digital world, safely and securely.
			 */
			WHAT_IS_OBJECTID_1: () => LocalizedString
			/**
			 * Create a brand new identity profile to get started.
			 */
			WHAT_IS_OBJECTID_2: () => LocalizedString
			/**
			 * Create new profile
			 */
	...
	DOMAIN_LINKAGE: {
		...
		TITLE: () => LocalizedString
		/**
		 * ObjectID successfully verified the identity to provide you with a secure login.
		 */
		SUCCESS: () => LocalizedString
		/**
		 * ObjectID could not verify the linkage of the identity to the domain.
		 */
		FAILURE: () => LocalizedString
		/**
		 * ObjectID could not find any proof of the domain's associated identity.
		 */
