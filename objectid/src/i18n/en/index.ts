...
const en = {
  ONBOARDING: {
    WELCOME: {
      GREETING: 'Welcome to',
      WHAT_IS_OBJECTID_1: 'ObjectID connects your digital world, safely and securely.',
      WHAT_IS_OBJECTID_2: 'Create a brand new identity profile to get started.',
      CREATE_NEW_PROFILE: 'Create new profile',
      SELECT_LANGUAGE: 'Select language',
    },
    PLEDGE: {
      NAVBAR_TITLE: 'ObjectID Pledge',
      TITLE_1: 'No funny',
      TITLE_2: 'business',
      ...
      T_AND_C: {
        ...
        FULL: {
          ...
          DEFINITIONS: {
            TITLE: 'Definitions',
            DESCRIPTION:
              'The term Service refers to the ObjectID Identity Wallet mobile application and includes any features, content, or services provided within it. User Data means any data, credentials, or information that you store or share using the Service. The term Device refers to the mobile phone or hardware on which the ObjectID app is installed and used.',
          },
    ...
    PASSWORD: {
      ...
      COMPLETED: {
        ...
        TITLE_1: 'Your ObjectID profile is now',
        TITLE_2: 'protected',
  ...
  ADD_CREDENTIALS: {
    ...
    PROFILE: {
      ...
      INFO: {
        ...
        TITLE: 'ObjectID Profile',
        DESCRIPTION: 'Before you start',
        ITEM_0: {
          TITLE: 'Skip tedious forms',
          DESCRIPTION:
            'Your ObjectID profile acts like a digital ID. Use it to auto-fill details instantly on supported sites, cutting the clutter from your online life.',
        },
        ITEM_1: {
  ...
  DOMAIN_LINKAGE: {
    ...
    SUCCESS: 'ObjectID successfully verified the identity to provide you with a secure login.',
    FAILURE: 'ObjectID could not verify the linkage of the identity to the domain.',
    UNKNOWN: "ObjectID could not find any proof of the domain's associated identity.",
