...
mkdir -p ../gen/android/app/src/main/java/com/objectid/wallet
cp -v ./android/app/src/main/java/com/objectid/wallet/MainActivity.kt ../gen/android/app/src/main/java/com/objectid/wallet/MainActivity.kt
