...
const de_DE = {
  ONBOARDING: {
    WELCOME: {
      ...
      WHAT_IS_OBJECTID_1: 'ObjectID verbindet deine digitale Welt, sicher und geschützt.',
      WHAT_IS_OBJECTID_2: 'Erstelle ein brandneues Profil, um loszulegen.',
      CREATE_NEW_PROFILE: 'Neues Profil erstellen',
      SELECT_LANGUAGE: 'Sprache auswählen',
    },
    PLEDGE: {
      NAVBAR_TITLE: 'ObjectIDs Versprechen',
      ...
      T_AND_C: {
        ...
        FULL: {
          ...
          DEFINITIONS: {
            TITLE: 'Definitionen',
            DESCRIPTION:
              'Der Begriff „Dienst“ bezeichnet die ObjectID Identity Wallet Mobile App und umfasst alle darin enthaltenen Funktionen, Inhalte oder Services. Benutzerdaten sind alle Daten, Zugangsdaten oder Informationen, die du über den Dienst speicherst oder teilst. Der Begriff „Gerät“ bezeichnet das Mobiltelefon oder die Hardware, auf dem/der die ObjectID App installiert und genutzt wird.',
          },
    ...
    PASSWORD: {
      ...
      COMPLETED: {
        ...
        TITLE_1: 'Dein ObjectID Profil ist jetzt',
        TITLE_2: 'geschützt',
    ...
    PROFILE: {
      ...
      INFO: {
        ...
        ITEM_0: {
          ...
          DESCRIPTION:
            'Dein ObjectID-Profil funktioniert wie ein digitaler Ausweis. Verwende es, um Details auf unterstützten Websites sofort automatisch auszufüllen und so Unordnung in deinem Online-Leben zu vermeiden.',
        },
        ITEM_1: {
  ...
  DOMAIN_LINKAGE: {
    ...
    SUCCESS: 'ObjectID konnte die Identität erfolgreich verifizieren, um dir einen sicheren Login zu ermöglichen.',
    FAILURE: 'ObjectID konnte die Verknüpfung der Identität mit der Domain nicht überprüfen.',
    UNKNOWN: 'ObjectID konnte keinen Nachweis über die verbundene Identität der Domain finden.',
